    ...
    <div className='border-t-1 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 mt-2'>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae, fuga harum aliquid reprehenderit natus hic quae cum! Sunt, nam tempore.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem adipisci nostrum enim exercitationem similique commodi quis iusto ut rerum iste!</p>
        </div>
      </div>
